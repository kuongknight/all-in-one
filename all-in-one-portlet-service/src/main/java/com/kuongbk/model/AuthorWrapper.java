...
public class AuthorWrapper implements Author, ModelWrapper<Author> {
    ...
    */
    ...
    /**
    * Returns the description of this author.
    *
    * @return the description of this author
    */
    @Override
    public java.lang.String getDescription() {
        return _author.getDescription();
    }

    /**
    * Sets the description of this author.
    *
    * @param description the description of this author
    */
    @Override
    public void setDescription(java.lang.String description) {
        _author.setDescription(description);
    }

    /**
    * Returns the born of this author.
    *
    * @return the born of this author
    */
    @Override
    public java.util.Date getBorn() {
        return _author.getBorn();
    }

    /**
    * Sets the born of this author.
    *
    * @param born the born of this author
    */
    @Override
    public void setBorn(java.util.Date born) {
        _author.setBorn(born);
    }

    /**
    * Returns the male of this author.
    *
    * @return the male of this author
    */
    @Override
    public java.lang.Boolean getMale() {
        return _author.getMale();
    }

    /**
    * Sets the male of this author.
    *
    * @param male the male of this author
    */
    @Override
    public void setMale(java.lang.Boolean male) {
        _author.setMale(male);
    }

    /**
    * Returns the status of this author.
    *
    * @return the status of this author
    */
    @Override
    public int getStatus() {
        return _author.getStatus();
    }

    /**
    * Sets the status of this author.
    *
    * @param status the status of this author
    */
    @Override
    public void setStatus(int status) {
        _author.setStatus(status);
    }
    ...
    @Override
    public int compareTo(com.kuongbk.model.Author author) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<com.kuongbk.model.Author> toCacheModel() {
        return _author.toCacheModel();
    }

    @Override
    public com.kuongbk.model.Author toEscapedModel() {
        return new AuthorWrapper(_author.toEscapedModel());
    }

    @Override
    public com.kuongbk.model.Author toUnescapedModel() {
