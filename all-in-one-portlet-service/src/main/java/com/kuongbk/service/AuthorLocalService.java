 ...
 * @see com.kuongbk.service.base.AuthorLocalServiceBaseImpl
 * @see com.kuongbk.service.impl.AuthorLocalServiceImpl
 * @generated
 */
...
public interface AuthorLocalService extends BaseLocalService,
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link AuthorLocalServiceUtil} to access the author local service. Add custom service methods to {@link com.kuongbk.service.impl.AuthorLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
    ...
    */
    ...
    public com.kuongbk.model.Author addAuthor(com.kuongbk.model.Author author)
    ...
    */
    public com.kuongbk.model.Author createAuthor(long authorId);
    ...
    */
    ...
    public com.kuongbk.model.Author deleteAuthor(long authorId)
    ...
    */
    @com.liferay.portal.kernel.search.Indexable(type = IndexableType.DELETE)
    public com.kuongbk.model.Author deleteAuthor(
    ...
    */
    ...
    public com.kuongbk.model.Author fetchAuthor(long authorId)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public com.kuongbk.model.Author fetchAuthorByUuidAndCompanyId(
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public com.kuongbk.model.Author fetchAuthorByUuidAndGroupId(
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public com.kuongbk.model.Author getAuthor(long authorId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public com.kuongbk.model.Author getAuthorByUuidAndCompanyId(
        java.lang.String uuid, long companyId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public com.kuongbk.model.Author getAuthorByUuidAndGroupId(
        java.lang.String uuid, long groupId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public java.util.List<com.kuongbk.model.Author> getAuthors(int start,
        int end) throws com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @com.liferay.portal.kernel.search.Indexable(type = IndexableType.REINDEX)
    public com.kuongbk.model.Author updateAuthor(
        com.kuongbk.model.Author author)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public void addBookAuthor(long bookId, com.kuongbk.model.Author author)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public void deleteBookAuthor(long bookId, com.kuongbk.model.Author author)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public java.util.List<com.kuongbk.model.Author> getBookAuthors(long bookId)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public java.util.List<com.kuongbk.model.Author> getBookAuthors(
