...
import com.kuongbk.NoSuchAuthorException;

import com.kuongbk.model.Author;
import com.kuongbk.model.impl.AuthorImpl;
import com.kuongbk.model.impl.AuthorModelImpl;
...
public class AuthorPersistenceImpl extends BasePersistenceImpl<Author>
    ...
    public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(AuthorModelImpl.ENTITY_CACHE_ENABLED,
            ...
            AuthorModelImpl.CREATEDATE_COLUMN_BITMASK);
    ...
    public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_STATUS = new FinderPath(AuthorModelImpl.ENTITY_CACHE_ENABLED,
            AuthorModelImpl.FINDER_CACHE_ENABLED, AuthorImpl.class,
    ...
    public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_STATUS =
        new FinderPath(AuthorModelImpl.ENTITY_CACHE_ENABLED,
            ...
            AuthorModelImpl.STATUS_COLUMN_BITMASK |
            AuthorModelImpl.CREATEDATE_COLUMN_BITMASK);
    public static final FinderPath FINDER_PATH_COUNT_BY_STATUS = new FinderPath(AuthorModelImpl.ENTITY_CACHE_ENABLED,
            AuthorModelImpl.FINDER_CACHE_ENABLED, Long.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByStatus",
            new String[] { Integer.class.getName() });
    private static final String _FINDER_COLUMN_STATUS_STATUS_2 = "author.status = ?";
    ...
    protected TableMapper<Author, com.kuongbk.model.Book> authorToBookTableMapper;
    ...
    public List<Author> findByUuid(String uuid, int start, int end,
        ...
        if (list == null) {
            ...
            try {
                ...
                if (!pagination) {
                    list = (List<Author>) QueryUtil.list(q, getDialect(),
                            start, end, false);
     ...
     * @throws com.kuongbk.NoSuchAuthorException if a matching author could not be found
     * @throws SystemException if a system exception occurred
     */
    @Override
     ...
     * @throws com.kuongbk.NoSuchAuthorException if a author with the primary key could not be found
     * @throws SystemException if a system exception occurred
     */
    @Override
    ...
    /**
     * Returns the author where uuid = &#63; and groupId = &#63; or throws a {@link com.kuongbk.NoSuchAuthorException} if it could not be found.
     *
     * @param uuid the uuid
    ...
    /**
     * Returns all the authors where status = &#63;.
     *
     ...
     */
    @Override
    public List<Author> findByStatus(int status) throws SystemException {
        return findByStatus(status, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
    }

    /**
     * Returns a range of all the authors where status = &#63;.
     *
     * <p>
     * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.kuongbk.model.impl.AuthorModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
     * </p>
     ...
     */
    @Override
    public List<Author> findByStatus(int status, int start, int end)
        throws SystemException {
        return findByStatus(status, start, end, null);
    }

    /**
     * Returns an ordered range of all the authors where status = &#63;.
     *
     * <p>
     * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.kuongbk.model.impl.AuthorModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
     * </p>
    ...
    /**
     * Returns the first author in the ordered set where status = &#63;.
     *
     * @param status the status
     * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
     * @return the first matching author
     ...
     */
    @Override
    public Author findByStatus_First(int status,
        OrderByComparator orderByComparator)
        throws NoSuchAuthorException, SystemException {
        Author author = fetchByStatus_First(status, orderByComparator);
     ...
     */
    @Override
    public Author fetchByStatus_First(int status,
        OrderByComparator orderByComparator) throws SystemException {
        List<Author> list = findByStatus(status, 0, 1, orderByComparator);
    ...
    /**
     * Returns the last author in the ordered set where status = &#63;.
     *
     * @param status the status
     * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
     * @return the last matching author
     ...
     */
    @Override
    public Author findByStatus_Last(int status,
        OrderByComparator orderByComparator)
        throws NoSuchAuthorException, SystemException {
        Author author = fetchByStatus_Last(status, orderByComparator);
     ...
     */
    @Override
    public Author fetchByStatus_Last(int status,
        OrderByComparator orderByComparator) throws SystemException {
        ...
        List<Author> list = findByStatus(status, count - 1, count,
                orderByComparator);
    ...
    /**
     * Returns the authors before and after the current author in the ordered set where status = &#63;.
     *
     * @param authorId the primary key of the current author
     * @param status the status
     * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
     ...
     */
    @Override
    public Author[] findByStatus_PrevAndNext(long authorId, int status,
        OrderByComparator orderByComparator)
        throws NoSuchAuthorException, SystemException {
        Author author = findByPrimaryKey(authorId);
        ...
        try {
            ...
            array[0] = getByStatus_PrevAndNext(session, author, status,
                    orderByComparator, true);

            array[1] = author;

            array[2] = getByStatus_PrevAndNext(session, author, status,
                    orderByComparator, false);
    ...
    protected Author getByStatus_PrevAndNext(Session session, Author author,
    ...
    /**
     * Removes all the authors where status = &#63; from the database.
     *
     * @param status the status
     * @throws SystemException if a system exception occurred
     */
    ...
    public void removeByStatus(int status) throws SystemException {
        for (Author author : findByStatus(status, QueryUtil.ALL_POS,
                QueryUtil.ALL_POS, null)) {
            remove(author);
        }
    }
    ...
    /**
     * Returns the number of authors where status = &#63;.
     *
     * @param status the status
     * @return the number of matching authors
     * @throws SystemException if a system exception occurred
    ...
    @Override
    public Author updateImpl(com.kuongbk.model.Author author)
        throws SystemException {
        author = toUnwrappedModel(author);
        ...
        if (isNew || !AuthorModelImpl.COLUMN_BITMASK_ENABLED) {
            ...
            if ((authorModelImpl.getColumnBitmask() &
                ...
                Object[] args = new Object[] { authorModelImpl.getOriginalStatus() };

                FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_STATUS, args);
                FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_STATUS,
                    args);

                args = new Object[] { authorModelImpl.getStatus() };
    ...
    protected Author toUnwrappedModel(Author author) {
        ...
        authorImpl.setDescription(author.getDescription());
        authorImpl.setBorn(author.getBorn());
        authorImpl.setMale(author.getMale());
        authorImpl.setStatus(author.getStatus());
    ...
    /**
     * Returns the author with the primary key or throws a {@link com.kuongbk.NoSuchAuthorException} if it could not be found.
     *
     * @param authorId the primary key of the author
     * @return the author
     * @throws com.kuongbk.NoSuchAuthorException if a author with the primary key could not be found
     ...
     */
    @Override
    public List<com.kuongbk.model.Book> getBooks(long pk)
        throws SystemException {
     ...
     */
    @Override
    public List<com.kuongbk.model.Book> getBooks(long pk, int start, int end)
        throws SystemException {
     ...
     */
    @Override
    public void addBook(long pk, com.kuongbk.model.Book book)
        throws SystemException {
     ...
     */
    @Override
    public void addBooks(long pk, List<com.kuongbk.model.Book> books)
        throws SystemException {
        for (com.kuongbk.model.Book book : books) {
            authorToBookTableMapper.addTableMapping(pk, book.getPrimaryKey());
        }
    }
     ...
     */
    @Override
    public void removeBook(long pk, com.kuongbk.model.Book book)
        throws SystemException {
     ...
     */
    @Override
    public void removeBooks(long pk, List<com.kuongbk.model.Book> books)
        throws SystemException {
        for (com.kuongbk.model.Book book : books) {
            authorToBookTableMapper.deleteTableMapping(pk, book.getPrimaryKey());
        }
     ...
     */
    @Override
    public void setBooks(long pk, List<com.kuongbk.model.Book> books)
        throws SystemException {
        try {
            long[] bookPKs = new long[books.size()];

            for (int i = 0; i < books.size(); i++) {
                com.kuongbk.model.Book book = books.get(i);
            ...
            FinderCacheUtil.clearCache(AuthorModelImpl.MAPPING_TABLE_MTT_AUTHOR_BOOK_NAME);
        }
    }
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.kuongbk.model.Author")));
        ...
        authorToBookTableMapper = TableMapperFactory.getTableMapper("MTT_author_book",
    ...
    public void destroy() {
        ...
        TableMapperFactory.removeTableMapper("MTT_author_book");
    }
}
