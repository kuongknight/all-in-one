...
import com.kuongbk.model.impl.BookImpl;
import com.kuongbk.model.impl.BookModelImpl;
...
public class BookPersistenceImpl extends BasePersistenceImpl<Book>
    ...
    public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_STATUS = new FinderPath(BookModelImpl.ENTITY_CACHE_ENABLED,
            BookModelImpl.FINDER_CACHE_ENABLED, BookImpl.class,
    ...
    public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_STATUS =
        new FinderPath(BookModelImpl.ENTITY_CACHE_ENABLED,
            ...
            BookModelImpl.CREATEDATE_COLUMN_BITMASK);
    public static final FinderPath FINDER_PATH_COUNT_BY_STATUS = new FinderPath(BookModelImpl.ENTITY_CACHE_ENABLED,
            BookModelImpl.FINDER_CACHE_ENABLED, Long.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByStatus",
            new String[] { Integer.class.getName() });
    private static final String _FINDER_COLUMN_STATUS_STATUS_2 = "book.status = ?";
    ...
    protected TableMapper<Book, com.kuongbk.model.Author> bookToAuthorTableMapper;
     ...
     */
    @Override
    public List<Book> findByStatus(int status) throws SystemException {
     ...
     */
    @Override
    public List<Book> findByStatus(int status, int start, int end)
        throws SystemException {
     ...
     */
    @Override
    public Book findByStatus_First(int status,
        OrderByComparator orderByComparator)
        throws NoSuchBookException, SystemException {
        Book book = fetchByStatus_First(status, orderByComparator);
     ...
     */
    @Override
    public Book fetchByStatus_First(int status,
        OrderByComparator orderByComparator) throws SystemException {
        List<Book> list = findByStatus(status, 0, 1, orderByComparator);
     ...
     */
    @Override
    public Book findByStatus_Last(int status,
        OrderByComparator orderByComparator)
        throws NoSuchBookException, SystemException {
        Book book = fetchByStatus_Last(status, orderByComparator);
     ...
     */
    @Override
    public Book fetchByStatus_Last(int status,
        OrderByComparator orderByComparator) throws SystemException {
     ...
     */
    @Override
    public Book[] findByStatus_PrevAndNext(long bookId, int status,
        OrderByComparator orderByComparator)
        throws NoSuchBookException, SystemException {
        Book book = findByPrimaryKey(bookId);
        ...
        try {
            ...
            array[0] = getByStatus_PrevAndNext(session, book, status,
                    orderByComparator, true);

            array[1] = book;

            array[2] = getByStatus_PrevAndNext(session, book, status,
                    orderByComparator, false);
    ...
    protected Book getByStatus_PrevAndNext(Session session, Book book,
    ...
    public void removeByStatus(int status) throws SystemException {
        for (Book book : findByStatus(status, QueryUtil.ALL_POS,
                QueryUtil.ALL_POS, null)) {
            remove(book);
        }
    }
    ...
    @Override
    public Book updateImpl(com.kuongbk.model.Book book)
        throws SystemException {
        book = toUnwrappedModel(book);
        ...
        if (isNew || !BookModelImpl.COLUMN_BITMASK_ENABLED) {
            ...
            if ((bookModelImpl.getColumnBitmask() &
                ...
                Object[] args = new Object[] { bookModelImpl.getOriginalStatus() };

                FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_STATUS, args);
                FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_STATUS,
                    args);

                args = new Object[] { bookModelImpl.getStatus() };
    ...
    protected Book toUnwrappedModel(Book book) {
        ...
        bookImpl.setPublishDate(book.getPublishDate());
        bookImpl.setStatus(book.getStatus());
        bookImpl.setViewCount(book.getViewCount());
     ...
     */
    @Override
    public List<com.kuongbk.model.Author> getAuthors(long pk)
        throws SystemException {
     ...
     */
    @Override
    public List<com.kuongbk.model.Author> getAuthors(long pk, int start, int end)
        throws SystemException {
     ...
     */
    @Override
    public List<com.kuongbk.model.Author> getAuthors(long pk, int start,
        int end, OrderByComparator orderByComparator) throws SystemException {
     ...
     */
    @Override
    public void addAuthors(long pk, List<com.kuongbk.model.Author> authors)
        throws SystemException {
        for (com.kuongbk.model.Author author : authors) {
            bookToAuthorTableMapper.addTableMapping(pk, author.getPrimaryKey());
        }
    }
     ...
     */
    @Override
    public void removeAuthors(long pk, List<com.kuongbk.model.Author> authors)
        throws SystemException {
        for (com.kuongbk.model.Author author : authors) {
     ...
     */
    @Override
    public void setAuthors(long pk, List<com.kuongbk.model.Author> authors)
        throws SystemException {
        try {
            long[] authorPKs = new long[authors.size()];

            for (int i = 0; i < authors.size(); i++) {
                com.kuongbk.model.Author author = authors.get(i);
            ...
            FinderCacheUtil.clearCache(BookModelImpl.MAPPING_TABLE_MTT_BOOK_AUTHOR_NAME);
        }
    }
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.kuongbk.model.Book")));
        ...
        bookToAuthorTableMapper = TableMapperFactory.getTableMapper("MTT_book_author",
    ...
    public void destroy() {
        ...
        TableMapperFactory.removeTableMapper("MTT_book_author");
    }
}
