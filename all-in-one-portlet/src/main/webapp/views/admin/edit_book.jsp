...
<%
	...
	if(bookId != 0 ){
		...
		b =  BookPermission.contains(permissionChecker, bookId, ActionKeys.PERMISSIONS);
	}
	System.out.println(b);
	b = AllOnePortletPermission.contains(permissionChecker, PortalUtil.getScopeGroupId(request), ActionKeys.PERMISSIONS);
	System.out.println(b);
%>
